<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
  <div class="navbar-brand-wrapper d-flex align-items-center" style="height: 110px;">
    <a class="navbar-brand brand-logo overflow-hidden justify-content-center" href="inicio">
      <img src="vistas/images/logo.png" alt="logo" class="w-100 h-100" />
    </a>
    <a class="navbar-brand brand-logo-mini" href="index">
      <img src="vistas/images/logo-mini.svg" alt="logo" />
    </a>
  </div>
      ...
      <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
          ...
          <a class="dropdown-item" href="salir">
            <i class="dropdown-item-icon icon-power text-primary"></i>Salir
          </a>
        </div>
      </li>
