           ...
           preg_match('/^[a-zA-Z0-9]+$/', $_POST["ingPassword"])){
            ...
            if($respuesta && 
               ...
               $respuesta["password"] == $encriptar){
                ...
                // Guardar último login (puedes descomentar esta parte si deseas)
            ...
            echo '<br><div class="alert alert-danger">No se permiten caracteres especiales, vuelve a intentarlo</div>';
        }
        ...
        if(isset($_POST["editarUsuario"])){
            ...
            if(preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["editarNombre"])){
                ...
                $datos = array(
                    ...
                    "gmail" => $_POST["editarGmail"],
                    "usuario" => $_POST["editarUsuario"],
                    "password" => $encriptar,
                    "perfil" => $_POST["editarPerfil"],
                    "foto" => $ruta,
                    "estado" => $_POST["editarEstado"] ?? 1,
                    "ultimo_login" => $_POST["editarUltimoLogin"] ?? null
                );
